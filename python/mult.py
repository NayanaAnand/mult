...
from mult_base import *

class mult_i(mult_base):
    ...
    def process(self):
        ...
        Messages:
            ...
            self.port_input.registerMessage("my_msg", mult_i.MyMsg, self.msg_callback)
